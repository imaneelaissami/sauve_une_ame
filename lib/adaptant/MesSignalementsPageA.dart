...
class MesSignalementsPageA extends StatefulWidget {
  final String email;

  const MesSignalementsPageA({Key? key, required this.email}) : super(key: key);

  @override
  _MesSignalementsPageAState createState() => _MesSignalementsPageAState();
}

class _MesSignalementsPageAState extends State<MesSignalementsPageA> {
  ...
  Future<void> fetchSignalements() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        item['userType'] == 'adoptantUser' && item['email'] == widget.email).toList();
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 6),
                            isEditing
                                ? TextField(controller: fullNameController, decoration: InputDecoration(labelText: 'fullName'))
